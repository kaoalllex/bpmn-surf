...
// because App calls isButtonPresent / isOwnButtonClick / reset unconditionally on
// the mouseup/popstate hot path — so the stub must never inject a button, never
// claim a click, and never error. Subtask 2 replaces this with real GitHub button
// injection (and flips isAvailable to detect github.com).
