...
4. **Верификация** — ошибка исправлена, остальное не затронуто; запусти `npm test` (юнит-тесты, ~0.5 сек); если баг в покрытом тестами классе (см. CLAUDE.md «Тестирование») — сначала добавь падающий тест/фикстуру, затем фикс
