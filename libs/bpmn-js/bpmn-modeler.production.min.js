/*! bpmn-js - bpmn-modeler v16.3.0 | Copyright (c) 2014-present, camunda Services GmbH | bpmn.io/license */
...
/*! Hammer.JS - v2.0.7 - 2016-04-22
  ...
  `}function Kc(e){const{onClose:t,onKeydown:n,onKeyup:i,className:r,children:o,position:a}=e,s=Bc(),c=Oc((e=>{ee(e.target,".djs-popup",!0)||t()}),[t]);return Dc((()=>{if("function"!=typeof a)return;const e=s.current,t=a(e);e.style.left=`${t.x}px`,e.style.top=`${t.y}px`}),[s.current,a]),Dc((()=>{s.current&&s.current.focus()}),[]),bc`
    <div
